...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.scheduler.context_processors.platform',
                'apps.settings.context_processors.settings',
                'apps.posting.context_processors.all_posts',
                'apps.posting.context_processors.platform',
                'apps.posting.context_processors.date_filter',
                'apps.posting.context_processors.status_filter',
                'apps.scheduler.context_processors.date_filter',
